...
static const _TrackedObject_type_support_symbol_names_t _TrackedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_interfaces, msg, TrackedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perception_interfaces, msg, TrackedObject)),
  }
};
...
{
  return &::perception_interfaces::msg::rosidl_typesupport_cpp::TrackedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perception_interfaces, msg, TrackedObject)() {
  return get_message_type_support_handle<perception_interfaces::msg::TrackedObject>();
}
