...
bool perception_interfaces__msg__tracked_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._tracked_object.TrackedObject", full_classname_dest, 55) == 0);
  }
  perception_interfaces__msg__TrackedObject * ros_message = _ros_message;
  {  // track_id
...
PyObject * perception_interfaces__msg__tracked_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._tracked_object");
